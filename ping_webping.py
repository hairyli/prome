...
class Requests_Response():
    ...
    def push_gate(self):
        ...
        for url in self.ip_ports:
            self.get_response(url)
        try:

            pushadd_to_gateway(self.targets, job='request_status', registry=self.registry, timeout=200)
...
class creatpinger:
    ...
    def create(self):
        ...
        self.g = Gauge(self.type, '状态-响应时间', ['ip', 'status', 'timestamp', 'response_time'], registry=self.registry)
